...
from pydaygal.sponsorships import BENEFIT_WEB_LOGO, BENEFIT_TYPE_CHOICES, BENEFIT_SIMPLE, BENEFIT_FILE, BENEFIT_TEXT
from pydaygal.sponsorships.managers import SponsorManager
