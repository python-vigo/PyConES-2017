...
#, python-format
msgid "Field must be at least %(min)s character long."
msgid_plural "Field must be at least %(min)s characters long."
msgstr[0] "El camp ha de contenir almenys %(min)s caràcter."
msgstr[1] "El camp ha de contenir almenys %(min)s caràcters."

#: wtforms/validators.py:99
#, python-format
msgid "Field cannot be longer than %(max)s character."
msgid_plural "Field cannot be longer than %(max)s characters."
msgstr[0] "El camp no pot contenir més de %(max)s caràcter."
msgstr[1] "El camp no pot contenir més de %(max)s caràcters."

#: wtforms/validators.py:102
#, python-format
msgid "Field must be between %(min)s and %(max)s characters long."
msgstr "El camp ha de contenir entre %(min)s i %(max)s caràcters."
