...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Submitting Patches &#8212; pgAdmin 4 1.3 documentation</title>
...
<div class="highlight-default"><div class="highlight"><pre><span></span>$ git clone git://git.postgresql.org/git/pgadmin4.git
</pre></div>
</div>
...
might run:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span>$ git diff origin/master &gt; my_cool_feature.diff
</pre></div>
</div>
